    ...
    def rotate(self, face, clockwise):
        ...
        if face == 'l':
            ...
            if clockwise == 'y':
                ...
                self.back[0][2] = self.upper[0][0]
                self.back[1][2] = self.upper[1][0]
                self.back[2][2] = self.upper[2][0]
